...
public class KeyCommandMod {
    ...
    public static class GuiInventory extends GuiScreen {
        ...
        public static void initializePathSequences() {
            ...
            anger0.addAction(player -> sendChatCommand("/res tp baonu"));
            
            PathStep anger1 = new PathStep(new double[]{-43, 85, -34});
            anger1.addAction(new DelayAction(10));
            ...
            DailyTask1b.addAction(new DelayAction(10));
            ...
            DailyTask2.addAction(new DelayAction(10));
            ...
            DailyTask3.addAction(new DelayAction(10));
            ...
            DailyTask4.addAction(new DelayAction(10));
            ...
            DailyTask5a.addAction(new DelayAction(10));
            ...
            DailyTask6.addAction(new DelayAction(10));
            ...
            DailyTask7a.addAction(new DelayAction(10));
